...
public class Book {
    ...
    public void setLanguage(String newLanguage) { bid.set(newLanguage);}
    ...
    public void setSID(String newSID) { sid.set(newSID);}

    public StringProperty borrow_dateProperty() { return borrow_date;}
    public String getBorrow_date() { return borrow_date.get();}
    public void setBorrow_date(String newBorrow_date) { borrow_date.set(newBorrow_date);}
}
